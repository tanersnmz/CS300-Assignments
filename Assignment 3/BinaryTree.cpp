...
//This class is taken from the lecture slides.
...
/*This class takes the node of the tree and update it, it will be used in main file. */

template <class Comparable>
void BinarySearchTree<Comparable>::updateTree(const Comparable& oldOne, const Comparable& newOne){
	BinaryNode<Comparable> * elementToBeUpdated = find(oldOne,root);
	elementToBeUpdated->element = newOne;
}
...
/*** Internal method to print a subtree rooted at t in sorted order. It will use helper stack additionally.*/
template <class Comparable>
